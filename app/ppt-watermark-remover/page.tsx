...
import { pptSeoPageContent } from "@/content/pages/ppt-watermark-remover";
...
export default function PptWatermarkRemoverPage() {
  const content = pptSeoPageContent;
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <section className="px-4 py-6 sm:px-6 sm:py-8">
        <ContentGridBlock
          title={content.whatItHelpsWith.title}
          intro={content.whatItHelpsWith.intro}
          items={content.whatItHelpsWith.items}
        />
      </section>

      <section className="px-4 py-6 sm:px-6 sm:py-8">
        <ContentGridBlock
          title={content.supportedScenarios.title}
          intro={content.supportedScenarios.intro}
          items={content.supportedScenarios.items}
        />
      </section>

      <section className="px-4 py-6 sm:px-6 sm:py-8">
        <ContentGridBlock
          title={content.whyManualSlow.title}
          intro={content.whyManualSlow.intro}
          items={content.whyManualSlow.items}
        />
      </section>

      <section id="how-workflow-works" className="px-4 py-6 sm:px-6 sm:py-8">
