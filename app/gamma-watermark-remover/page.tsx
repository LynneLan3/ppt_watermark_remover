...
export default function GammaWatermarkRemoverPage() {
  const content = gammaSeoAssistPageContent;
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <section className="px-4 py-6 sm:px-6 sm:py-8">
        <ContentGridBlock
          title={content.whyCleanupNeeded.title}
          intro={content.whyCleanupNeeded.intro}
          items={content.whyCleanupNeeded.items}
        />
      </section>

      <section className="px-4 py-6 sm:px-6 sm:py-8">
        <ContentGridBlock
          title={content.commonSituations.title}
          intro={content.commonSituations.intro}
          items={content.commonSituations.items}
        />
      </section>
